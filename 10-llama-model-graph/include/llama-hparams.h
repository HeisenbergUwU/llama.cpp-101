// llama-hparams.h - 06 章「超参数 HParams」：从 GGUF KV 读出决定架构的超参 + 派生维度。
// 只做 plain llama 最小字段集（~10 个 + 派生 getter），不抄上游上百字段。KV 读取对齐 llama-model.cpp load_hparams、派生对齐 llama-hparams.cpp。
